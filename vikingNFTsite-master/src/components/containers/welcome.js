...
import logo8 from '../static/media/8.png'
...
import logo17 from '../static/media/17.png'
                ...
                <Row>
                    ...
                    <Container>
                        <div className="image">
                            ...
                            <Carousel className="Carrousel" cols={4} rows={1} gap={1} autoplay={3000} loop={true} hideArrow={true} mobileBreakpoint={200}>
